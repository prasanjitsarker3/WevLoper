...
const FooterSection = () => {
  return (
    <div>
      <footer className="relative w-full bg-[#0b1816]">
        <div className="mx-auto w-full">
            ...
            <div className="grid grid-cols-3 justify-between gap-4">
              {LINKS.map(({ title, items }) => (
                <ul key={title}>
                  <Typography
                    variant="small"
                    className="mb-3 text-lg poppins-regular  text-white"
                  >
                    {title}
                  </Typography>
                  {items.map((link) => (
          ...
          <div className="mt-12 flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between px-12 pb-5">
            <Typography
              variant="small"
